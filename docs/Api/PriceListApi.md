...
$body = new \Swagger\Client\Model\PriceList(); // \Swagger\Client\Model\PriceList | The new PriceList resource
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\PriceList**](../Model/PriceList.md)| The new PriceList resource | [optional]
