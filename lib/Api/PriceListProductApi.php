...
class PriceListProductApi
{
    ...
    protected function deletePriceListProductItemRequest($id)
    {
        ...
        $resourcePath = '/product/price_list_products/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\InlineResponse2001
     */
    public function getPriceListProductCollection($product = null, $price_list = null, $page = '1', $items_per_page = '30', $pagination = null)
    {
        list($response) = $this->getPriceListProductCollectionWithHttpInfo($product, $price_list, $page, $items_per_page, $pagination);
        return $response;
    }
     ...
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VentureLeap\ProductService\Model\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceListProductCollectionWithHttpInfo($product = null, $price_list = null, $page = '1', $items_per_page = '30', $pagination = null)
    {
        $returnType = '\VentureLeap\ProductService\Model\InlineResponse2001';
        $request = $this->getPriceListProductCollectionRequest($product, $price_list, $page, $items_per_page, $pagination);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\ProductService\Model\InlineResponse2001',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPriceListProductCollectionAsync($product = null, $price_list = null, $page = '1', $items_per_page = '30', $pagination = null)
    {
        return $this->getPriceListProductCollectionAsyncWithHttpInfo($product, $price_list, $page, $items_per_page, $pagination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPriceListProductCollectionAsyncWithHttpInfo($product = null, $price_list = null, $page = '1', $items_per_page = '30', $pagination = null)
    {
        $returnType = '\VentureLeap\ProductService\Model\InlineResponse2001';
        $request = $this->getPriceListProductCollectionRequest($product, $price_list, $page, $items_per_page, $pagination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPriceListProductCollectionRequest($product = null, $price_list = null, $page = '1', $items_per_page = '30', $pagination = null)
    {

        $resourcePath = '/product/price_list_products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($price_list !== null) {
            $queryParams['priceList'] = ObjectSerializer::toQueryValue($price_list, null);
        }
        // query params
        if ($page !== null) {
     ...
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductRead
     */
     ...
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceListProductItemWithHttpInfo($id)
    {
        $returnType = '\VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductRead';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductRead',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $id id (required)
     * @param  \VentureLeap\ProductService\Model\PriceListProductPriceListProductWrite $body The updated PriceListProduct resource (optional)
     *
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductRead
     ...
     *
     * @param  \VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductWrite $body The new PriceListProduct resource (optional)
     *
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductRead
     ...
     *
     * @param  string $id id (required)
     * @param  \VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductWrite $body The updated PriceListProduct resource (optional)
     *
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\PriceListProductJsonldPriceListProductRead
