...
class ConfigurationEntryApi
{
    ...
    protected function deleteConfigurationEntryItemRequest($id)
    {
        ...
        $resourcePath = '/product/configuration_entries/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\InlineResponse200
     */
     ...
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VentureLeap\ProductService\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\VentureLeap\ProductService\Model\InlineResponse200';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\ProductService\Model\InlineResponse200',
    ...
    protected function getConfigurationEntryCollectionRequest($key = null, $value = null, $application_id = null, $page = '1', $items_per_page = '30', $pagination = null)
    {
        ...
        $resourcePath = '/product/configuration_entries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\ConfigurationEntryJsonldConfigurationRead
     */
     ...
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VentureLeap\ProductService\Model\ConfigurationEntryJsonldConfigurationRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function getConfigurationEntryItemWithHttpInfo($id)
    {
        $returnType = '\VentureLeap\ProductService\Model\ConfigurationEntryJsonldConfigurationRead';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\ProductService\Model\ConfigurationEntryJsonldConfigurationRead',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \VentureLeap\ProductService\Model\ConfigurationEntryJsonldConfigurationWrite $body The new ConfigurationEntry resource (optional)
     *
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\ConfigurationEntryJsonldConfigurationRead
     ...
     *
     * @param  string $id id (required)
     * @param  \VentureLeap\ProductService\Model\ConfigurationEntryJsonldConfigurationWrite $body The updated ConfigurationEntry resource (optional)
     *
     * @throws \VentureLeap\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ProductService\Model\ConfigurationEntryJsonldConfigurationRead
