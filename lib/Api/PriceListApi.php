...
class PriceListApi
{
     ...
     */
    public function getPriceListCollection($name = null, $custom_data = null, $pagination = null)
    {
        list($response) = $this->getPriceListCollectionWithHttpInfo($name, $custom_data, $pagination);
        return $response;
    }
     ...
     */
    public function getPriceListCollectionWithHttpInfo($name = null, $custom_data = null, $pagination = null)
    {
        $returnType = '\VentureLeap\ProductService\Model\InlineResponse2002';
        $request = $this->getPriceListCollectionRequest($name, $custom_data, $pagination);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPriceListCollectionAsync($name = null, $custom_data = null, $pagination = null)
    {
        return $this->getPriceListCollectionAsyncWithHttpInfo($name, $custom_data, $pagination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPriceListCollectionAsyncWithHttpInfo($name = null, $custom_data = null, $pagination = null)
    {
        $returnType = '\VentureLeap\ProductService\Model\InlineResponse2002';
        $request = $this->getPriceListCollectionRequest($name, $custom_data, $pagination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPriceListCollectionRequest($name = null, $custom_data = null, $pagination = null)
    {
