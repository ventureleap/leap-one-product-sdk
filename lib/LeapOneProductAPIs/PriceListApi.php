...
case 200:$data = ObjectSerializer::deserialize(
                        $content,
                        '\Swagger\Client\LeapOneProductModels\InlineResponse2001',
...
*
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\LeapOneProductModels\PriceListJsonld
     */
...
*
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\LeapOneProductModels\PriceListJsonld, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceListItemWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\LeapOneProductModels\PriceListJsonld';
...
case 200:$data = ObjectSerializer::deserialize(
                        $content,
                        '\Swagger\Client\LeapOneProductModels\PriceListJsonld',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
...
*
* @param  string $id id (required)
* @param  \Swagger\Client\LeapOneProductModels\PriceList $body The updated PriceList resource (optional)
*
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\LeapOneProductModels\PriceListJsonld
...
*
* @param  \Swagger\Client\LeapOneProductModels\PriceListJsonld $body The new PriceList resource (optional)
*
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\LeapOneProductModels\PriceListJsonld
...
*
* @param  string $id id (required)
* @param  \Swagger\Client\LeapOneProductModels\PriceListJsonld $body The updated PriceList resource (optional)
*
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\LeapOneProductModels\PriceListJsonld
