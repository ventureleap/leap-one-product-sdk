...
class PriceListProductApi
{
     ...
     */
    public function getPriceListProductCollection($page = '1')
    {
     ...
     */
    public function getPriceListProductCollectionWithHttpInfo($page = '1')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPriceListProductCollectionAsync($page = '1')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPriceListProductCollectionAsyncWithHttpInfo($page = '1')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->getPriceListProductCollectionRequest($page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPriceListProductCollectionRequest($page = '1')
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PriceListProductJsonld
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PriceListProductJsonld, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceListProductItemWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\PriceListProductJsonld';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PriceListProductJsonld',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $id id (required)
     * @param  \Swagger\Client\Model\PriceListProduct $body The updated PriceListProduct resource (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PriceListProductJsonld
     ...
     *
     * @param  \Swagger\Client\Model\PriceListProductJsonld $body The new PriceListProduct resource (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PriceListProductJsonld
     ...
     * Creates a PriceListProduct resource.
     *
     * @param  \Swagger\Client\Model\PriceListProduct $body The new PriceListProduct resource (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PriceListProductJsonld
     ...
     *
     * @param  string $id id (required)
     * @param  \Swagger\Client\Model\PriceListProductJsonld $body The updated PriceListProduct resource (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PriceListProductJsonld
